...
import '../util/utils/navigation_util.dart';
import '../util/utils/route_util.dart';
import '../util/utils/toast_util.dart';
...
abstract class BaseState<T extends StatefulWidget, B extends BaseBloc>
  ...
  void showSuccessMsg(String msg) {
    ...
    showToast(msg, Icons.check_circle, UIConstants.blackColor);
  }
